# MedClaw Container Agent Skills Reference
...
Skills for everyday productivity tasks — useful in any domain, not specific to healthcare.
...
Skills specifically designed for healthcare, clinical, and biomedical workflows.
...
| oral-health-analyzer | Oral health assessment: dental symptom analysis, periodontal risk, oral cancer screening awareness, and preventive dental care guidance. |
| skin-health-analyzer | Dermatological health analysis: skin condition tracking, lesion documentation, UV exposure assessment, and skincare regimen optimization. |
| sexual-health-analyzer | Sexual health assessment: STI risk evaluation, reproductive health tracking, contraception guidance, and sexual wellness education. |
| food-database-query | Query comprehensive food databases for nutritional content, ingredient lists, allergen information, and dietary compatibility. |
...
| nutrigx_advisor | Nutrigenomics advisor — SNP-based personalized dietary recommendations across 13 nutrient domains. |
...
| biomaster-workflows | BioMaster workflow orchestration for complex multi-step bioinformatics analyses. |
